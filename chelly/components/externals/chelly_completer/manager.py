...
class CompleterManager:
    ...
    def set_completion_list(self, completion_list_widget:BaseCompletionWidget, new:bool = False) -> BaseCompletionWidget:
        if new:
    ...
    def set_completion_tooltip(self, completion_widget: BaseCompletionWidget) -> BaseCompletionWidget:
