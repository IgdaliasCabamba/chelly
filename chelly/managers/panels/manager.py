...
class PanelsManager(PanelsSizeHelpers):
    ...
    def append(
        self, panel: Panel, zone=Panel.Position.LEFT, settings=Panel.WidgetSettings()
    ) -> Panel:
    ...
    def update(
        self, rect: object, delta_y: int, force_update_margins: bool = False
    ) -> None:
        """Updates panels"""
